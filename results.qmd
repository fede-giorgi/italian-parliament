...
This outcome was strenghtened by the "Rosatellum" electoral law: out of 400 seats, **148 deputies** were elected via the **uninominal colleges** (First Past the Post method). These candidates were supported by the entire coalition, and are often grouped by their broader **bloc**, while the remaining were assigned via proportional plurinominal lists.
...
The legislative machine runs at full speed only on **Tuesdays and Wednesdays**. Mondays and Fridays are phantom days, with low voting activity. The data validates the stereotype: for the average deputy, the parliamentary week effectively lasts 48 to 72 hours.
...
Does the majority on paper translate into actual voting power? 
To check whether the **Center-Right coalition** can pass legislation, we tracked approved motions over time, looking specifically at votes where the government got the outcome it wanted.
...
* **Amendments (Grey):** This scatterplot mirrors the chaos of the general "Geometry of Consensus". The distribution is scattered and chaotic, without clear blocs or clean party divisions.
