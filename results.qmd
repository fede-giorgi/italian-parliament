...
# 1. Compare the Region Names
print("--- DATA NAMES (First 10) ---")
df_college_winners |> head(10) |> pull(join_key) |> print()

print("--- MAP NAMES (First 10) ---")
map_pluri |> 
  mutate(clean_name = str_to_upper(CP20_DEN) |> str_remove_all("[^A-Z0-9]")) |> 
  pull(clean_name) |> head(10) |> print()

# 2. Check for Roman Numeral mismatch (e.g., LAZIO1 vs LAZIOI)

df_deputati_final |> 
  filter(party_acronym == "Unknown/Misto") |> 
  count(final_party_raw, sort = TRUE)
```
